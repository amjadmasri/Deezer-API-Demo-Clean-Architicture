...
class GetArtistsAlbumsUseCase @Inject constructor(private val artistRepository: ArtistRepository) {

    fun execute(artistId: String): Observable<PagedList<AlbumDomainModel>> {
